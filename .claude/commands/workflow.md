...
|-------|----------|-------------|
| On `main`, no uncommitted changes | **Idle** | Pick an issue: `gh issue list --state open` → create branch |
| On `main`, with uncommitted changes | **Uncommitted work on main** | Create a branch first, then commit |
...
| On feature branch, PR open, CI passed | **Ready to merge** | Merge PR |
