...
class KaguraClient:
    ...
    async def remember(
        ...
        Args:
            ...
            type: Memory type (e.g. ``"note"``, ``"document"``,
                ``"document_section"``). Server validates against its own
            ...
            details: Structured details JSON. Use for additional metadata
                like ``{"parent_id": ..., "role": "section",
                "section_index": 0}`` on ingested document sections.
